...
function initPlan(){
	...
	var tomorrow = new Date().toISOString().slice(8, 10);
	tomorrow = (parseInt(tomorrow)).toString();
	document.getElementById('startTime').value = today + tomorrow + "T06:00";
	document.getElementById('startPlace').value = "Bengaluru";
}
...
function initTime(){
	...
	var tomorrow = new Date().toISOString().slice(8, 10);
	tomorrow = (parseInt(tomorrow)).toString();
	document.getElementById('arrival').value = today + tomorrow + "T06:00";
	tomorrow = (parseInt(tomorrow)).toString();
	document.getElementById('departure').value = today + tomorrow + "T06:00";
}
